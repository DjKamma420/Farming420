export const CORE_FORTUNE_VERIFIED = '2026-09-23';
 ...
 * reference here.
 *
 * This file is intentionally separate from src/data.js so the test suite can
 * cross-check every
...
export const CORE_FORTUNE_FACTS = Object.freeze([
  ...
  Object.freeze({
    ...
    stepGain: 4,
    publishedMaximum: 4,
    note: 'A Relic of Power with only a Perfect Peridot contributes +4 Farming Fortune; +5 requires the fully gemmed/recombobulated Relic.',
    source: CORE_FORTUNE_SOURCE,
    lastVerified: CORE_FORTUNE_VERIFIED,
  }),
]);
