...
export const UPGRADES = [
  ...
  },
  {
    ...
    "rawMarginal": 0,
    "hypercharge": false,
    "optionTag": "feast / overbloom",
    "notes": "+2 Overbloom per level, max +10 at Feast V. Kept out of raw Fortune ranking because Overbloom needs event/Rare Crop EV rather than a fake Farming Fortune conversion.",
    "source": "https://hypixelskyblock.minecraft.wiki/w/Feast",
    "lastVerified": "2026-09-18",
    "workbookRank": null
  },
  {
    "id": "tool-enchant-crop-fever-v",
    "category": "Tool Enchant",
    "section": "tools",
    "name": "Crop Fever",
    "metric": "Proc Uptime",
    ...
    "rawMarginal": 0,
    "hypercharge": false,
    "optionTag": "ultimate / proc",
    "notes": "Ultimate enchant. Each level raises the per-break proc chance; the 60s proc grants +100 Farming Fortune, +15 Overbloom and additional crop rolls. Do not turn that burst into permanent Fortune without break-rate/uptime context.",
    "source": "https://hypixelskyblock.minecraft.wiki/w/Enchantments",
    "lastVerified": "2026-09-18",
    "workbookRank": null
  },
  {
    "id": "tool-enchant-replenish",
    "category": "Tool Enchant",
    "section": "tools",
    "name": "Replenish",
    "metric": "Throughput",
    ...
    "rawMarginal": 0,
    "hypercharge": false,
    "optionTag": "conditional",
    "notes": "Automatically replants supported crops from inventory. Useful when the farm actually needs replanting; it has no direct Fortune and should not be valued like one.",
    "source": "https://hypixelskyblock.minecraft.wiki/w/Replenish",
    "lastVerified": "2026-09-18",
    "workbookRank": null
  },
  {
    "id": "tool-enchant-delicate-v",
    "category": "Tool Enchant",
    "section": "tools",
    "name": "Delicate",
    "metric": "Farm Integrity",
    "modeScope": "Any",
    "cropScope": "Any",
    "status": "ACTIVE",
    "min": 5,
    ...
    "rawMarginal": 0,
    "hypercharge": false,
    "optionTag": "contextual",
    "notes": "Only Delicate V exists. It prevents breaking stems and baby crops. This is a layout-dependent utility enchant, not a universal profit upgrade.",
