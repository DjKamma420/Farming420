...
export const ENCHANT_LADDERS = Object.freeze([
  ...
  },
  {
    ...
    scope: 'Farming tool',
    tag: 'Harvest Feast',
    perLevel: '+2 Overbloom',
    max: 'V, +10 Overbloom',
    steps: [
      { levels: 'I', from: 'Feast Baker Scott for Kernels' },
      { levels: 'II-V', from: 'Combining books' },
    ],
    note: 'Event/Rare Crop value. Do not convert Overbloom directly into permanent Farming Fortune.',
  },
  {
    id: 'replenish',
    name: 'Replenish',
    scope: 'Farming tool',
    tag: 'Conditional',
    perLevel: 'Automatically replants supported harvested crops',
    max: 'I',
    steps: [
      { levels: 'I', from: 'Cocoa Beans VIII recipe or Librarian visitor reward' },
    ],
    note: 'Useful when the farm needs replanting. Regrowing stem/cane/cactus layouts do not get the same throughput value.',
  },
  {
    id: 'delicate',
    name: 'Delicate',
    scope: 'Farming tool',
    tag: 'Contextual',
    perLevel: 'Prevents breaking stems and baby crops',
    max: 'V only; tiers I-IV do not exist',
    steps: [
      { levels: 'V', from: 'Anita for 2 Silver Medals + 32 Jacob\'s Tickets, or Librarian visitor reward' },
    ],
    note: 'A farm-integrity tool, not a universal profit upgrade. Some layouts intentionally do not want this protection.',
  },
  {
    id: 'sunset',
    name: 'Sunset',
    scope: 'Armor',
    tag: 'Ultimate / Overbloom',
    perLevel: 'Daytime Overbloom; nighttime Visitor cooldown while farming',
    max: 'V',
    steps: [
      { levels: 'I', from: 'Lunar Moth drop' },
      { levels: 'II-V', from: 'Combining books' },
    ],
  },
  {
    ...
    scope: 'Armor',
    tag: 'Secret strat',
    perLevel: 'Normal combat reflect; additionally feeds Thorny equipment\'s Overbloom bonus',
    max: 'IV',
    steps: [
      { levels: 'I-III', from: 'Enchantment Table / combining books' },
      { levels: 'IV', from: 'Prickly Creeper applied to Thorns III armor' },
    ],
    note: 'Farming relevance only appears with the Thorny equipment reforge. Otherwise it is not a Farming Fortune enchant.',
  },
  {
    id: 'bug-blender',
    name: 'Bug Blender',
    scope: 'Vacuum',
    tag: 'Pest',
    perLevel: '+20 Farming Fortune while vacuuming Pests',
    max: 'V, +100 Farming Fortune while vacuuming Pests',
    steps: [
