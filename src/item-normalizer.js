...
import { skullTextureFromTag } from './skull-art.js';
...
export function normalizeDecodedItem(item, context = {}) {
  ...
  return {
    ...
    itemModel: stringOrNull(tag.ItemModel ?? tag.item_model ?? tag.itemModel),
    displayName: stringOrNull(display.Name),
    displayColor: numberOrNull(display.color ?? display.Color),
    ...
    skullTexture: skullTextureFromTag(tag),
  };
}
